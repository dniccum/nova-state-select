...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-nova-state-select', __webpack_require__(3));
    Vue.component('detail-nova-state-select', __webpack_require__(6));
    Vue.component('form-nova-state-select', __webpack_require__(9));
});
